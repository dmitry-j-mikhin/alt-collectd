...
Patch1: %name-%version-python.patch
...
%{?_enable_curl_json:Requires: %name-curl_json}
...
%{?_enable_python:Requires: %name-python}
...
%if_enabled curl_json
%package curl_json
Summary: Curl_json support module for collectd
Group: Monitoring
Requires: collectd = %version-%release
BuildRequires: libcurl-devel, libyajl-devel

%description curl_json
This plugin provides CURL_json support for collectd
%endif
...
%if_enabled python
%package python
Summary: Python support module for collectd
Group: Monitoring
Requires: collectd = %version-%release
BuildRequires: python3-dev

%description python
This plugin provides Python support for collectd
%endif
...
%{?_enable_curl_json:%exclude %_libdir/%name/curl_json.so}
...
%{?_enable_postgresql:%exclude %_libdir/%name/python.so}
